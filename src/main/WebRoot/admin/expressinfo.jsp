...
<div class="easyui-layout" fit="true">
	...
	<div align="left" id="toolbar">
		<input class="easyui-textbox" id="searchtitle"  prompt="请输入收货人姓名" />
	...
	<div id="dlg" class="easyui-dialog" style="width:500px;height:510px;padding:10px 20px"
		...
		<form id="fm" method="post" enctype="multipart/form-data"  novalidate>
			...
			<div class="fitem">
				<label>邮编:</label>
				<input name="zipcode" id="zipcode" class="easyui-textbox" data-options="disabled:true">
			</div>
			<div class="fitem">
				<label>默认地址:</label>
				<select id="isdefault" name="isdefault" editable="false" class="easyui-combobox" panelHeight="60" style="width: 164px;" data-options="disabled:true">
