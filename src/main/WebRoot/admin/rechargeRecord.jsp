...
<div class="easyui-layout" fit="true">
	...
	<div align="left" id="toolbar">
		...
		<span style=" float: right">
	        ...
	        <a href="#" class="easyui-linkbutton" id="btn_quarter4" onclick="searchData(0)" data-options="iconCls:'finish',plain:true,toggle:true,group:'g3'">未付款</a>
	        <a href="#" class="easyui-linkbutton" id="btn_quarter3" onclick="searchData(1)" data-options="iconCls:'excuting',plain:true,toggle:true,group:'g3'">已付款</a>
		</span>
	</div>
	<div id="dlg" class="easyui-dialog" style="width:500px;height:510px;padding:10px 20px"
		 closed="true" modal="true" buttons="#dlg-buttons">
		<div class="ftitle">充值记录</div>
		<form id="fm" method="post" enctype="multipart/form-data"  novalidate>
			...
			<div class="fitem">
				<label>充值金额:</label>
				<input name="amount" id="amount" class="easyui-textbox" data-options="disabled:true">
			</div>
			<div class="fitem">
				<label>姓名:</label>
